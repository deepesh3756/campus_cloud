...
const ProfilePageCommon = ({
  ...
  initialEmail = "",
  initialPhone = "",
  initialProfileImage = "https://i.pravatar.cc/300",
  nameDisabled = true,
}) => {
  ...
  const displayName = useMemo(() => formData.name || initialName || "User", [formData.name, initialName]);
          ...
          <div className="card shadow-sm border-0 text-center p-4 mb-4">
            ...
            <form onSubmit={handleProfileSubmit} className="mt-4 text-start">
              <div className="mb-3">
                ...
                <input className="form-control" value={formData.name} disabled={nameDisabled} readOnly={nameDisabled} />
              </div>
